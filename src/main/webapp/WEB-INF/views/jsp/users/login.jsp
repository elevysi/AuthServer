...
<c:url var="loginFormPostActionUrl" value="/login" />
	...
	<form:form cssClass="reg-page" action="${loginFormPostActionUrl}" method="POST">
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<input name="submit" type="submit" value="<spring:message code="label.login.signInButton" />" class="btn-u btn-block"/>
			</div>
		</div>
